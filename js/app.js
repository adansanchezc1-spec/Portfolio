        ...
        <div class="project-card-footer">
          ...
          <div class="project-links">
            ...
            ${project.links.demo && project.links.demo !== '#' ? `
              <a href="${project.links.demo}" target="_blank" rel="noopener noreferrer" class="social-icon-btn" title="Ver Demo / Reporte" style="width: 34px; height: 34px; color: #34d399;">
  ...
  modalContent.innerHTML = `
    ...
    <div>
      ...
      <div style="display: flex; gap: 14px; margin-top: 28px; padding-top: 18px; border-top: 1px solid var(--border-subtle); flex-wrap: wrap;">
        ...
        ` : ''}
        ${project.links.demo && project.links.demo !== '#' ? `
          <a href="${project.links.demo}" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-sm">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>
            Ver Demo / Entregable
          </a>
        ` : ''}
